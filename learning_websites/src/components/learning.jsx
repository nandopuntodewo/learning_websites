...
import bglearning from "../assets/bg/learningbg.svg";
import bgvideo from "../assets/bg/videobg.svg";
...
export default function Learning() {
  return (
    <div>
      ...
      >
        <div className="ps-9 pe-9 md:ps-44 md:pe-44">
          ...
          <div className="mt-11" id="section1">
            <p className="font-semibold text-2xl md:text-3xl mb-10">
              Section #1
            </p>
      ...
      >
        <div className="ps-9 pe-9 pb-10 md:ps-44 md:pe-44">
